...
class HeadLaporanPembayaranSupplier extends Component {
  constructor(props) {
    super(props);
    this.state = {
      listSupplier: [],
...
HeadLaporanPembayaranSupplier = reduxForm({
  form: "HeadLaporanPembayaranSupplier",
  enableReinitialize: true,
})(HeadLaporanPembayaranSupplier);
export default connect()(HeadLaporanPembayaranSupplier);
